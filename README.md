[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/mamashinharyas6-boop/Haryas-Admin/blob/main/LICENSE)

# Haryas Admin (Official Continuation)

Haryas Admin keeps the original script alive and adds new commands, fixes, and plugin support.
...
- Main: 
```
loadstring(game:HttpGet("https://raw.githubusercontent.com/mamashinharyas6-boop/Haryas-Admin/main/Source.lua"))()
```
- Testing:
```
loadstring(game:HttpGet("https://raw.githubusercontent.com/mamashinharyas6-boop/Haryas-Admin/main/HA%20testing.lua"))()
```
- Drop `.na` plugins in `Haryas-Admin/Plugins`
- Drop `.iy` (Infinite Yield style) plugins in `Haryas-Admin/PluginsIY`
...
2. Make sure these folders exist (create if missing):
   - `Haryas-Admin/Plugins` for `.na` files
   - `Haryas-Admin/PluginsIY` for `.iy` files
...
Put this in `Haryas-Admin/Plugins/hello.na`:
...
Put this in `Haryas-Admin/PluginsIY/example.iy`:

```lua
local Plugin = {
    PluginName = "ExamplePlugin",
    PluginDescription = "Shows how .iy maps to HA commands",
    Commands = {
        hello = {
...
## Maintainers
- [Vyperia (@mamashinharyas6-boop)](https://github.com/mamashinharyas6-boop)
- [Viper (@Cosmella)](https://github.com/Cosmella-v)

---

## Community
- Discord: [https://discord.gg/M6Pcqt3AR9](https://discord.gg/M6Pcqt3AR9)
...
## License
MIT — see [LICENSE](https://github.com/mamashinharyas6-boop/Haryas-Admin/blob/main/LICENSE).
